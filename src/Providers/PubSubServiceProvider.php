...
class PubSubServiceProvider extends LaravelQueueRabbitMQServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->publishes([
            __DIR__ . '/../../database/migrations/update_pubsub_events_table_add_failed_columns.php.stub' => $this->getMigrationFileName('_update_pubsub_events_table_add_failed_columns.php'),
        ], 'migrations');
